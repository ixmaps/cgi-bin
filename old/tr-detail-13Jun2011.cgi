...
def show_traceroute_hdr(tr):
    ...
    #yay for excessive pulling from the database! I'm ashamed of how awful this is
...
def show_one_traceroute(conn, traceroute_id):
    ...
    try:
        ...
        print '<th align="left"><a href="../faq.html#IP Address">IP Address</a></th><th> </th>'
        print '<th align="center" width=50><a href="../faq.html#Minimum Latency">Min. Latency</th>'
...
# This is for GeoPrecision, but using the old variable name
            if a_info['certainty'].isdigit():
...
legend_text="""
  ...
  <table>
    ...
    <tr>
      ...
      <td>NSA:</td><td>Known or suspected NSA listening facility in the city</td></tr>
    <tr>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
print """<br><br><a href="http://ixmaps.ischool.utoronto.ca/cgi-bin/tr-detail-geek.cgi?traceroute_id=%s"> Geek version <href>""" % traceroute_id
print response_end
