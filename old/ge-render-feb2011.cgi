...
def print_ch_style(ch):
  ...
  <IconStyle>
    ...
    <BalloonStyle>
      <text><![CDATA[<table border="0" width="305" cellspacing="0" cellpadding="0"><tr align="left" valign="top"><td width="100%%" align="left" valign="top"> <p><a href="http://www.ixmaps.ca/"; title="IXmaps"><img src="http://www.ixmaps.ca/ge/ixmaps.png" alt="" width="270" height="60"></a></p><p>%(facility)s</p><p>$[name]</p> <p><strong>$[name]</strong></p>$[description]</td></tr></table>]]></text>
    </BalloonStyle>
   </Style>"""
