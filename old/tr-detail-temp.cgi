...
#country related stuff has been removed (all of the flags) for the demo... ctrl-f for 'removed' to reinsert
...
def show_one_traceroute(conn, traceroute_id):
    ...
    try:
        ...
        # display the table
        print '<table><tr><th>Hop</th><th>IP Address</th><th>Type</th><th colspan="%d">Round Trip Times</th>' % nattempts,
        ...
        for hop in range(nhops):
            ...
            nsa_icon     = icon_prefix + ixmaps2_tmp.nsa_flag_colour(ip_info) + icon_suffix			# Sorry about the messiness here, it's the last night before the demo
            #country_icon = icon_prefix + ixmaps2_tmp.get_country(ip_info) + icon_suffix	# temp removed
...
#'nsa10x10.png'
            ...
            print "<img src=\"" + nsa_icon +    "\" />",
            print "<img src=\"" + chotel_icon + "\" />",
#            print "<img src=\"" + country_icon +"\" />",		# temp removed
            print "</td>"
...
def show_grp_traceroutes(conn, submitter, zip_code):
    ...
    try:
        ...
        for tr in tr_grp:
            ...
            print "<td align=\"center\">",
            print "&nbsp;"
            print "<img width='1' src=\"" + nsa_icon +    "\" />",
...
proximity_link='<p>You can also look up traceroutes by <a href="tr-distance.cgi">geographic proximity</a> to a location.</p>'
